...
let cardBack;
function preload() {
  cardBack = loadImage('images/card_back.jpg');
  cardfaceArray = [
    loadImage('images/card_0.jpg'),
    loadImage('images/card_1.jpg'),
    loadImage('images/card_2.jpg'),
    loadImage('images/card_3.jpg'),
    loadImage('images/card_4.jpg'),
    loadImage('images/card_5.jpg')
  ]
}
...
function draw() {
  ...
  fill(255);
  textSize(36);
  text('attempts: ' + gameState.attempts, 100, 550);
  text('matches: ' + gameState.numMatched, 100, 590)
}
